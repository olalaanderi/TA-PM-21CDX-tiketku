...
import com.example.tiketku.view.history.HistoryActivity
import com.example.tiketku.view.input.DataKapalActivity
import com.example.tiketku.view.input.DataKeretaActivity
import com.example.tiketku.view.input.DataPesawatActivity
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Kapal.setOnClickListener { v: View? ->
